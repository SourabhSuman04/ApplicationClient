...
export class SidebarComponent implements OnInit {
  ...
  navigationItems: NavItem[] = [
    { label: 'Home', route: 'home', icon: 'fas fa-users' },
    { label: 'Dashboard', route: 'dashboardhome', icon: 'fas fa-th-large' },
    { label: 'User', icon: 'fas fa-shopping-cart' , expanded: false,
      children: [
        { label: 'User Table', route: 'usertable'  },
        // { label: 'User View',route:'userview'}, 
        { label: 'Add User', route: 'add-user' },
      ]
     },
    { label: 'Analytics', route: 'analitics', icon: 'fas fa-chart-bar' },
